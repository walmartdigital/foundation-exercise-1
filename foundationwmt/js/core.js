...
let getProducts = (categoria) => {
  let url = `http://localhost:3001/api/products/${categoria}`;
    ...
    data.forEach(product => {
      ...
      `<div class="col-lg-4 col-md-6 mb-4">
        <div class="card h-100">
          <a href="#"><img class="card-img-top" src="${product["src-img"]}" alt=""></a>
          <div class="card-body">
            <h4 class="card-title">
              <a href="#">${product["product-name"]}</a>
            </h4>
            <h5>${product["price-sale"].toLocaleString('es-CL', {style: 'currency', currency: 'CLP'})}</h5>
